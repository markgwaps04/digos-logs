...
const $element = jq(".person_list_search .jsgrid");
    ...
    $element.jsGrid({
      ...
      loadIndicator : {
        show : () => jq(".person_list_search .overlay-spinner").addClass("show"),
        hide : () => jq(".person_list_search .overlay-spinner").removeClass("show")
      },
